...
NS_OBJECT_ENSURE_REGISTERED (LoraNoiseModelDefault);

LoraNoiseModelDefault::LoraNoiseModelDefault ()
{
...
TypeId
LoraNoiseModelDefault::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::LoraNoiseModelDefault")
    .SetParent<Object> ()
    .SetGroupName ("Lora")
    .AddConstructor<LoraNoiseModelDefault> ()
    .AddAttribute ("Wind", "Wind speed in m/s.",
                   DoubleValue (1),
                   MakeDoubleAccessor (&LoraNoiseModelDefault::m_wind),
                   MakeDoubleChecker<double> (0))
    .AddAttribute ("Shipping", "Shipping contribution to noise between 0 and 1.",
                   DoubleValue (0),
                   MakeDoubleAccessor (&LoraNoiseModelDefault::m_shipping),
...
double
LoraNoiseModelDefault::GetNoiseDbHz (double fKhz) const
{
