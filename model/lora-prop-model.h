...
#ifndef LORA_PROP_MODEL_H
#define LORA_PROP_MODEL_H
...
public:
   ...
   */
  LoraPdp (std::vector<Tap> taps, Time resolution);
  /**
   ...
   */
  LoraPdp (std::vector<std::complex<double > > arrivals, Time resolution);
  /**
   ...
   * \param resolution Time duration between arrivals in vector.
   */
  LoraPdp (std::vector<double> arrivals, Time resolution);
   ...
   */ 
  static LoraPdp CreateImpulsePdp (void);
  
private:
  friend std::ostream &operator<< (std::ostream &os, const LoraPdp &pdp);
  friend std::istream &operator>> (std::istream &is, LoraPdp &pdp);
 ...
 */
std::ostream &operator<< (std::ostream &os, const LoraPdp &pdp);
/**
 *
 ...
 */
std::istream &operator>> (std::istream &is, LoraPdp &pdp);  
 ...
 */
class LoraPropModel : public Object
{
public:
  /**
   * Register this type.
   ...
   */
  virtual double GetPathLossDb (Ptr<MobilityModel> a, Ptr<MobilityModel> b, LoraTxMode txMode) = 0;
   ...
   */
  virtual LoraPdp GetPdp (Ptr<MobilityModel> a, Ptr<MobilityModel> b, LoraTxMode mode) = 0;
  /**
   ...
   */
  virtual Time GetDelay (Ptr<MobilityModel> a, Ptr<MobilityModel> b, LoraTxMode mode) = 0;
