...
public:
  ...
  typedef void (* TracedCallback)
    (const Ptr<const Packet> pkt, const double sinr, const LoraTxMode mode);
   ...
   */
  virtual void StartRxPacket (Ptr<Packet> pkt, double rxPowerDb, LoraTxMode txMode, LoraPdp pdp) = 0;
   ...
   */
  virtual void NotifyTransStartTx (Ptr<Packet> packet, double txPowerDb, LoraTxMode txMode) = 0;
